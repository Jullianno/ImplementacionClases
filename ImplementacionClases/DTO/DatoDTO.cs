...
namespace ImplementacionClases.DTO
{
    public class DatoDTO
    {
        ...
        {
            for (int i = 0; i < datos.Count; i++) //Recorrer lista a traves de for y su conteo
            {
        ...
        public static bool Remove(int id)
        {
            ...
            {
                return false; //no se encontro el id para eliminar
            }
        }
        ...
        public static DatoDTO Find(DatoDTO dato)
        {
            ...
            return new DatoDTO();// si no se esncuentra, pasa del for y devuelve un ojbeto vacio
        }
